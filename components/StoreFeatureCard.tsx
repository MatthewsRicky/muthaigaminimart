...
const StoreFeatureCard = () => {
  return (
    <div className="flex flex-col justify-center items-center gap-8 md:w-[80%] my-20 mx-auto px-10 h-[60vh] overflow-hidden text-blue-900 bg-blue-500 bg-opacity-40">
      
      <h1 className="text-2xl font-semibold">WELCOME TO MUTHAIGA MINI MART</h1>
