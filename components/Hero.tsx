  ...
  return (
    <div className="w-full  mb-[10rem] mx-auto p-10 relative">
      <div 
        ...
        <div className=" border-blue-100 mt-[4rem] bg-blue-950/60 border-2 border-opacity-40 relative top-[20] z-10 flex flex-col justify-center p-8 rounded-lg items-center gap-8 text-white">
          <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold">Everything You Need at Great Prices</h1>
