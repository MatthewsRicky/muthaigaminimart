  ...
  return (
    <div className="w-full mb-10 mx-auto p-10 relative">
      <div 
        ...
        <div className="border-blue-100 mt-[10rem] bg-blue-800/40 border-2 border-opacity-60 relative z-10 flex flex-col justify-center p-8 rounded-lg items-center gap-8 text-white">
