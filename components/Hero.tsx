	...
	return (
		<div className="hero w-full my-[5rem] md:my-0 group relative">
			<motion.div
				...
				className="mt-[4rem] absolute top-[30%] left-10 md:left-[20%] sm:top-20 md:top-16 p-8 rounded-lg mx-auto text-center gap-8 text-[#fff] bg-[#000080]/40 mix-blend-hard-light"
			>
				<motion.h1
					initial={{ x: -300 }} // Initial x position (off the screen to the left)
					animate={{ x: 0 }} // Final x position (centered on the screen)
