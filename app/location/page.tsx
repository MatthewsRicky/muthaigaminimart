	...
	return (
		<div>
			...
			<div className="flex flex-wrap justify-center  md:items-center flex-col md:flex-row gap-10 md:p-10 md:my-10">
				...
				<div className="md:max-w-[450px-750px] items center drop-shadow-lg m-4 bg-blue-200/40 p-2 items-center flex flex-col gap-2 hover:shadow-md hover:shadow-[#ff2800] hover:scale-105">
