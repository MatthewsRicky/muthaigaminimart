...
const About = () => {
  return (
      <div
        ...
        className="flex flex-col justify-around gap-4 items-center h-[75vh] py-20 px-20 w-full bg-cover text-white relative">
          <div className="bg-blue-950/80 flex flex-col px-6 py-4 justify-around gap-8">
