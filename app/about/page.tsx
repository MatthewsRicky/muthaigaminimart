  ...
  return (
      ...
      className="text-white w-full">
        ...
        <h2 className="py-4 px-6 rounded-md shadow-md shadow-orange-500/90 text-4xl md:text-6xl lg:text-8xl text-orange-500/90 bg-blue-950/80 mx-[15%] transition-all duration-300">Muthatiga Mini Mart</h2>
          ...
          <div className="flex flex-col justify-center items-center text-blue-950 p-8 m-8">
            
            <p className="text-lg md:text-2xl lg:text-3xl font-semi-bold bg-blue-200/40 rounded-xl p-4 ">
              <i>Muthatiga Mini Mart</i> is a beloved destination in the heart of Diani Beach, a stunning coastal paradise. Our mini super market caters to the diverse needs of residents and visitors alike. Offering an extensive range of products and services, from locally sourced fresh produce to gourmet snacks and beach essentials, we strive to meet every customer's needs. With a friendly and inviting atmosphere, Muthatiga Mini Mart is dedicated to providing exceptional customer service, ensuring a convenient and enjoyable shopping experience in the vibrant Diani Beach community.
            </p>
            <Link href="/contact">
