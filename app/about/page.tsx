...
const About = () => {
  return (
      <div
        ...
        className="flex flex-col gap-4 items-center py-20 px-20 w-full bg-cover text-white">
          <div className="items-center bg-blue-950/80 flex flex-col px-6 py-4 justify-around gap-8">
            ...
            <Link href="/contact">
            <button className="bg-orange-500/80 p-4 mt-10 text-2xl md:text-3xl lg:text-4xl scale-75 md:scale-90 lg:scale-100 font-semibold transition hover:scale-105 hover:outline-2 rounded-md w-100">
              Talk to Us
            </button>
            </Link>
          </div>
